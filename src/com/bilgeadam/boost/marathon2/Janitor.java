...
public class Janitor extends Employee {
	private String Id;//sicil numarası için hizmetli için
	private int i= 0; //sayaç tanımladım.

	public Janitor(String name, String lastName, boolean isMiddle, String gender, boolean isMarried, LocalDate birthday,
	...
	public String toString() {
		return "Janitor [Id=" + Id + ", LastName=" + getLastName() + ", isMarried=" + isMarried()
	...
	public void incresaSalary() {
	    ...
	    if(intervalPeriod.getMonths()>=6) {
	    	this.setCurrentSalary(this.getCurrentSalary()*(1.085));
